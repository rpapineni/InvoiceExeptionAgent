...
def build_placeholder_output(
    ...
    *,
    ...
    payload = PocAOutput(
        ...
        exception_type=triage_result.get("exception_type"),
        reason_summary=triage_result.get("reason_summary"),
        recommended_owner=triage_result.get("recommended_owner"),
        priority=triage_result.get("priority"),
        next_actions=triage_result.get("next_actions"),
        questions_for_reviewer=triage_result.get("questions_for_reviewer"),
